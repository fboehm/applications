...
For each putative outcome variable, we performed a two-sample Mendelian randomization analysis with inverse-variance weighted, weighted median, and MR-Egger methods. We obtained association effect estimates for putative outcomes from publicly available summary statistics from UK Biobank GWAS [@neale_lab_gwas].
