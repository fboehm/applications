...
In particular, these populations are being used to extensively model and understand infectious diseases. While a 
great deal of data are available from a variety of model infections, analytical methods that enhance statistical 
...
Both Collaborative Cross and Diversity Outbred populations have been used to model tuberculosis pathogenesis.  Our group has performed deep 
...
We propose to develop an analytical framework that will leverage the strengths of both CC and DO datasets together. 
