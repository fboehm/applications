...
in the Diversity Outbred mice to identify a narrow genomic region that contains a QTL. For each QTL in the Diversity Outbred, we'll use our methods from Aim 1 to infer allelic series. 
...
Sharing our software offers the opportunity for our work to reach a larger audience 
and to have a greater impact than it otherwise would have.
