...
alleles (Collaborative Cross and Diversity Outbred mice, for example), our approach offers more statistical power when replicating QTL detection. 

A lynchpin in this aim is development of a Markov chain monte carlo 
sampler for Bayesian inference of allelic series at known QTL.
